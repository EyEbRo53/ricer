...
class TouchpadSettingsFeature(Feature):
    ...
    def execute(self, acceleration: float, speed: float, deceleration: float) -> bool:
...
def set_touchpad_settings(acceleration: float, speed: float, deceleration: float) -> bool:
    """Script entrypoint for confirmed touchpad settings changes."""
